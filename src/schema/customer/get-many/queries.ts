...
const getManyCustomersIR: any = {"usedParamSet":{"limit":true,"offset":true},"params":[{"name":"limit","required":false,"transform":{"type":"scalar"},"locs":[{"a":32,"b":37}]},{"name":"offset","required":false,"transform":{"type":"scalar"},"locs":[{"a":49,"b":55}]}],"statement":"SELECT * FROM customer \n  LIMIT :limit \n  OFFSET :offset"};
