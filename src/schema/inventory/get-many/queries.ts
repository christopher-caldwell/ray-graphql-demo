...
const getManyInventoriesIR: any = {
  usedParamSet: { limit: true, offset: true },
  params: [
    { name: 'limit', required: false, transform: { type: 'scalar' }, locs: [{ a: 33, b: 38 }] },
    { name: 'offset', required: false, transform: { type: 'scalar' }, locs: [{ a: 50, b: 56 }] },
  ],
 ...
 * ```
 */
export const getManyInventories = new PreparedQuery<IGetManyInventoriesParams, IGetManyInventoriesResult>(
  getManyInventoriesIR,
)
