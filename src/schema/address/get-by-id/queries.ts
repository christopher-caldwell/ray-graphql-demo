...
const getAddressByIdIR: any = {"usedParamSet":{"addressId":true},"params":[{"name":"addressId","required":false,"transform":{"type":"scalar"},"locs":[{"a":41,"b":50}]}],"statement":"SELECT * FROM address WHERE address_id = :addressId"};
