...
const getManyAddressesIR: any = {"usedParamSet":{"limit":true,"offset":true},"params":[{"name":"limit","required":false,"transform":{"type":"scalar"},"locs":[{"a":28,"b":33}]},{"name":"offset","required":false,"transform":{"type":"scalar"},"locs":[{"a":42,"b":48}]}],"statement":"SELECT * FROM address LIMIT :limit OFFSET :offset"};
