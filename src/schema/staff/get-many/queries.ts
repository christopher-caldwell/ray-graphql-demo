...
const getManyStaffMembersIR: any = {
 ...
 * ```
 */
export const getManyStaffMembers = new PreparedQuery<IGetManyStaffMembersParams, IGetManyStaffMembersResult>(
  getManyStaffMembersIR,
)
