...
const getStaffMemberByIdIR: any = {
  usedParamSet: { staffId: true },
  params: [{ name: 'staffId', required: false, transform: { type: 'scalar' }, locs: [{ a: 37, b: 44 }] }],
  statement: 'SELECT * FROM STAFF WHERE staff_id = :staffId',
}
 ...
 * ```
 */
export const getStaffMemberById = new PreparedQuery<IGetStaffMemberByIdParams, IGetStaffMemberByIdResult>(
  getStaffMemberByIdIR,
)
