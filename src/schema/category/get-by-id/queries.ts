...
const getCategoryByIdIR: any = {
  usedParamSet: { categoryId: true },
  params: [{ name: 'categoryId', required: false, transform: { type: 'scalar' }, locs: [{ a: 43, b: 53 }] }],
  statement: 'SELECT * FROM category WHERE category_id = :categoryId',
}
