...
const searchFilmsIR: any = {
  usedParamSet: { searchQuery: true, limit: true, offset: true },
  params: [
    { name: 'searchQuery', required: false, transform: { type: 'scalar' }, locs: [{ a: 51, b: 62 }] },
    { name: 'limit', required: false, transform: { type: 'scalar' }, locs: [{ a: 73, b: 78 }] },
    { name: 'offset', required: false, transform: { type: 'scalar' }, locs: [{ a: 90, b: 96 }] },
  ],
