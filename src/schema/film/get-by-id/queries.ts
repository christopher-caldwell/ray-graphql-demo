...
const getFilmByIdIR: any = {
  usedParamSet: { filmId: true },
  params: [{ name: 'filmId', required: false, transform: { type: 'scalar' }, locs: [{ a: 35, b: 41 }] }],
  statement: 'SELECT * FROM film WHERE film_id = :filmId',
}
