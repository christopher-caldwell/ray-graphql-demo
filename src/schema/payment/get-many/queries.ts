...
const getManyPaymentsIR: any = {"usedParamSet":{"limit":true,"offset":true},"params":[{"name":"limit","required":false,"transform":{"type":"scalar"},"locs":[{"a":31,"b":36}]},{"name":"offset","required":false,"transform":{"type":"scalar"},"locs":[{"a":48,"b":54}]}],"statement":"SELECT * FROM payment \n  LIMIT :limit \n  OFFSET :offset"};
