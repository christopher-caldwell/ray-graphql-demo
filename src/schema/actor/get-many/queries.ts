...
const getManyActorsIR: any = {
  usedParamSet: { limit: true, offset: true },
  params: [
    { name: 'limit', required: false, transform: { type: 'scalar' }, locs: [{ a: 26, b: 31 }] },
    { name: 'offset', required: false, transform: { type: 'scalar' }, locs: [{ a: 40, b: 46 }] },
  ],
  statement: 'SELECT * FROM actor LIMIT :limit OFFSET :offset',
}
