...
const getActorByIdIR: any = {
  usedParamSet: { actorId: true },
  params: [{ name: 'actorId', required: false, transform: { type: 'scalar' }, locs: [{ a: 37, b: 44 }] }],
  statement: 'SELECT * FROM actor WHERE actor_id = :actorId',
}
