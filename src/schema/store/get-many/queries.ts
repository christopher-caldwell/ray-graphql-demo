...
const getManyStoresIR: any = {"usedParamSet":{"limit":true,"offset":true},"params":[{"name":"limit","required":false,"transform":{"type":"scalar"},"locs":[{"a":29,"b":34}]},{"name":"offset","required":false,"transform":{"type":"scalar"},"locs":[{"a":46,"b":52}]}],"statement":"SELECT * FROM store \n  LIMIT :limit \n  OFFSET :offset"};
